...
- type key : 返回key的类型
- [SCAN cursor [MATCH pattern] [COUNT count] [TYPE type]](https://redis.io/commands/scan) :
...
- sadd key member1 [member] : 向集合中添加一个或多个元素
- sismenber key value : 判断value是否是集合key中的元素
