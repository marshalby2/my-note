...
Redis是一key-value数据库，数据的存储、修改、删除操作都是围绕这key来进行的。Redis keys是二进制安全的，我们可以使用一个字符串"foo"来表示key，空字符也是合法的。
{: id="20201010180354-p4nnhay"}

Redis Keys 的一些规则：
{: id="20201010181335-8jjnaau"}

-
{: id="20201010181337-x0juskp"}

{: id="20201010180209-16judku"}
